...
#library(hms) # Timeseries fucntions
```
...
ca_childcare |>
  select(study_year, county_name, mc_infant, mc_toddler, mc_preschool, region) |>
#  mutate(study_year = years(study_year)) |>
  pivot_longer(cols = starts_with("mc_"),
               names_to = "childcare_youth_type", 
               values_to = "med_center_childcare_value") |>                          # <3>
  mutate(childcare_youth_type = fct_recode(childcare_youth_type, 
                                           "Infant" = "mc_infant",                  # <4>
                                           "Toddler" = "mc_toddler",                
                                           "Preschool" = "mc_preschool")) |>
#  mutate(med_center_childcare_value = as.factor(med_center_childcare_value)) |>
  ggplot() +
  ...
  facet_wrap(~ childcare_youth_type) +
